...
double xmin_unfxjptave[7]   =   { minUnfoldingBin_xjptave  , minUnfoldingBin_xjptave , 0.0         , 0.0	     , 0.0 , 0.0 , multiplicity_centrality_bins[0]};
double xmax_unfxjptave[7]   =   { maxUnfoldingBin_xjptave  , maxUnfoldingBin_xjptave , TMath::Pi() , TMath::Pi() , 11.0, 11.0, multiplicity_centrality_bins[multbinsize-1]};
...
double xmin_unfpt1pt2[7]   =   { minUnfoldingBin_pt1pt2  , minUnfoldingBin_pt1pt2 , 0.0         , 0.0	      , 0.0 , 0.0  , multiplicity_centrality_bins[0]};
double xmax_unfpt1pt2[7]   =   { maxUnfoldingBin_pt1pt2  , maxUnfoldingBin_pt1pt2 , TMath::Pi() , TMath::Pi() , 11.0, 11.0 , multiplicity_centrality_bins[multbinsize-1]};
...
// histograms for unfolding
// Axis : 0 -> reco, 1 -> gen, 2 -> delta phi reco, 3 -> delta phi gen, 4 -> mid-fwd-bkw ranges reco, 5 -> mid-fwd-bkw ranges gen, 6 -> multiplicity
int	bins_unfxjpt2[7] 	  =   { nUnfoldingBins_xjpt2   , nUnfoldingBins_xjpt2  , nDphiBins   , nDphiBins   , 11  , 11  , multbinsize-1};
double xmin_unfxjpt2[7]   =   { minUnfoldingBin_xjpt2  , minUnfoldingBin_xjpt2 , 0.0         , 0.0	       , 0.0 , 0.0 , multiplicity_centrality_bins[0]};
double xmax_unfxjpt2[7]   =   { maxUnfoldingBin_xjpt2  , maxUnfoldingBin_xjpt2 , TMath::Pi() , TMath::Pi() , 11.0, 11.0, multiplicity_centrality_bins[multbinsize-1]};
THnSparseD *fhUnfoldingResponse_xjpt2 = new THnSparseD("fhUnfoldingResponse_xjpt2", "fhUnfoldingResponse_xjpt2", 7, bins_unfxjpt2, xmin_unfxjpt2, xmax_unfxjpt2);
// Axis : 0 -> Measured or Truth, 1 -> delta phi measured or truth, 2 ->  mid-fwd-bkw ranges, 3 -> multiplicity
...
double xmin_quenc[9]   =   { minxjhist 	 , minxjhist	  , 0.0		    	, multiplicity_centrality_bins[0]		   	  ,	 minPtLSL	 ,	extra_bins[0]				, minPtLSL	, minPtLSL  , 0.0};
double xmax_quenc[9]   =   { maxxjhist   , maxxjhist	  , TMath::Pi() 	, multiplicity_centrality_bins[multbinsize-1] ,  maxPtLSL    ,  extra_bins[extrabinsize-1]  , maxPtLSL	, maxPtLSL  , 11.0};
...
double xmin_quencEP[9]   =   { minxjhist  , 0.0		  	    , 0.0		 , 0.0			, 0.0			, multiplicity_centrality_bins[0]		   	  ,	 minPtLSL  ,  extra_bins[0]   			, 0.0};
double xmax_quencEP[9]   =   { maxxjhist  , TMath::Pi() 	, TMath::Pi(), TMath::Pi()	, TMath::Pi()	, multiplicity_centrality_bins[multbinsize-1] ,  maxPtLSL  ,  extra_bins[extrabinsize-1], 11.0};
...
double xmin_etaDijet[10]   =   { -5.0  , -4.0 , minxjhist	  , minxjhist , 0.0 	 	    , minX   ,  minX    , 	 multiplicity_centrality_bins[0]		   	  ,	 minPtLSL	 ,  extra_bins[0]};
double xmax_etaDijet[10]   =   {  5.0  ,  4.0 , maxxjhist	  , maxxjhist , TMath::Pi() 	, maxX   ,  maxX    , 	 multiplicity_centrality_bins[multbinsize-1]  ,  maxPtLSL    ,  extra_bins[extrabinsize-1]};
