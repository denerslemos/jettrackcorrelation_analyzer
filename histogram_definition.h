...
double AjBins[nXjAjBins+1] = {0.0,0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.55,0.6,0.7,0.8,0.9,1.0};
// less bins
...
int    bins_jetptclos[4]   =   { 100  ,  100  , multbinsize-1                               , extrabinsize-1};
double xmin_jetptclos[4]   =   { 0    ,  0    , multiplicity_centrality_bins[0]             , extra_bins[0]};
double xmax_jetptclos[4]   =   { 1000 ,  1000 , multiplicity_centrality_bins[multbinsize-1] , extra_bins[extrabinsize-1]};
THnSparseD *hist_jetptclos_weighted = new THnSparseD("hist_jetptclos_weighted", "hist_jetptclos_weighted", 4, bins_jetptclos, xmin_jetptclos, xmax_jetptclos);
THnSparseD *hist_leadjetptclos_weighted = new THnSparseD("hist_leadjetptclos_weighted", "hist_leadjetptclos_weighted", 4, bins_jetptclos, xmin_jetptclos, xmax_jetptclos);
THnSparseD *hist_subljetptclos_weighted = new THnSparseD("hist_subljetptclos_weighted", "hist_subljetptclos_weighted", 4, bins_jetptclos, xmin_jetptclos, xmax_jetptclos);
THnSparseD *hist_averjetptclos_weighted = new THnSparseD("hist_averjetptclos_weighted", "hist_averjetptclos_weighted", 4, bins_jetptclos, xmin_jetptclos, xmax_jetptclos);
THnSparseD *hist_diffjetptclos_weighted = new THnSparseD("hist_diffjetptclos_weighted", "hist_diffjetptclos_weighted", 4, bins_jetptclos, xmin_jetptclos, xmax_jetptclos);
THnSparseD *hist_leadjetptclosremovesome_weighed = new THnSparseD("hist_leadjetptclosremovesome_weighed", "hist_leadjetptclosremovesome_weighed", 4, bins_jetptclos, xmin_jetptclos, xmax_jetptclos);
THnSparseD *hist_subljetptclosremovesome_weighed = new THnSparseD("hist_subljetptclosremovesome_weighed", "hist_subljetptclosremovesome_weighed", 4, bins_jetptclos, xmin_jetptclos, xmax_jetptclos);
THnSparseD *hist_averjetptclosremovesome_weighed = new THnSparseD("hist_averjetptclosremovesome_weighed", "hist_averjetptclosremovesome_weighed", 4, bins_jetptclos, xmin_jetptclos, xmax_jetptclos);
THnSparseD *hist_diffjetptclosremovesome_weighed = new THnSparseD("hist_diffjetptclosremovesome_weighed", "hist_diffjetptclosremovesome_weighed", 4, bins_jetptclos, xmin_jetptclos, xmax_jetptclos);

int    bins_xjclos[4]   =   { 10   ,  10   , multbinsize-1                               , extrabinsize-1};
double xmin_xjclos[4]   =   { 0    ,  0    , multiplicity_centrality_bins[0]             , extra_bins[0]};
double xmax_xjclos[4]   =   { 1.0  ,  1.0  , multiplicity_centrality_bins[multbinsize-1] , extra_bins[extrabinsize-1]};
THnSparseD *hist_xjclos_weighted = new THnSparseD("hist_xjclos_weighted", "hist_xjclos_weighted", 4, bins_xjclos, xmin_xjclos, xmax_xjclos);
THnSparseD *hist_xjclos_removesome_weighted = new THnSparseD("hist_xjclos_removesome_weighted", "hist_xjclos_removesome_weighted", 4, bins_xjclos, xmin_xjclos, xmax_xjclos);
...
double xmax_quencEP[7]   =   { 1.0  	   , TMath::Pi() 	, TMath::Pi(), TMath::Pi()	, TMath::Pi()	, multiplicity_centrality_bins[multbinsize-1] ,  maxPtave};
...
hist_jetptclos_weighted->GetAxis(2)->Set(bins_jetptclos[2],MultCentbins);
hist_leadjetptclos_weighted->GetAxis(2)->Set(bins_jetptclos[2],MultCentbins);
hist_subljetptclos_weighted->GetAxis(2)->Set(bins_jetptclos[2],MultCentbins);
hist_averjetptclos_weighted->GetAxis(2)->Set(bins_jetptclos[2],MultCentbins);
hist_leadjetptclosremovesome_weighed->GetAxis(2)->Set(bins_jetptclos[2],MultCentbins);
hist_subljetptclosremovesome_weighed->GetAxis(2)->Set(bins_jetptclos[2],MultCentbins);
hist_averjetptclosremovesome_weighed->GetAxis(2)->Set(bins_jetptclos[2],MultCentbins);
hist_diffjetptclosremovesome_weighed->GetAxis(2)->Set(bins_jetptclos[2],MultCentbins);
hist_xjclos_weighted->GetAxis(2)->Set(bins_xjclos[2],MultCentbins);
hist_xjclos_removesome_weighted->GetAxis(2)->Set(bins_xjclos[2],MultCentbins);
...
hist_jetptclos_weighted->GetAxis(3)->Set(bins_jetptclos[3],Extrabins);
hist_leadjetptclos_weighted->GetAxis(3)->Set(bins_jetptclos[3],Extrabins);
hist_subljetptclos_weighted->GetAxis(3)->Set(bins_jetptclos[3],Extrabins);
hist_averjetptclos_weighted->GetAxis(3)->Set(bins_jetptclos[3],Extrabins);
hist_leadjetptclosremovesome_weighed->GetAxis(3)->Set(bins_jetptclos[3],Extrabins);
hist_subljetptclosremovesome_weighed->GetAxis(3)->Set(bins_jetptclos[3],Extrabins);
hist_averjetptclosremovesome_weighed->GetAxis(3)->Set(bins_jetptclos[3],Extrabins);
hist_diffjetptclosremovesome_weighed->GetAxis(3)->Set(bins_jetptclos[3],Extrabins);
hist_xjclos_weighted->GetAxis(3)->Set(bins_xjclos[3],Extrabins);
hist_xjclos_removesome_weighted->GetAxis(3)->Set(bins_xjclos[3],Extrabins);
...
hist_diffjetptclosremovesome_weighed->Sumw2();
...
void w_QA_hist(bool isMC){
	...
	if(isMC){
		...
		hist_diffjetptclosremovesome_weighed->Write();
