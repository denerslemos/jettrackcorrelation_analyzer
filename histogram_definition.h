...
THnSparseD *hist_reco_sublEP_quench_minus = new THnSparseD("hist_reco_sublEP_quench_minus", "hist_reco_sublEP_quench_minus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_ref_sublEP_quench_plus = new THnSparseD("hist_ref_sublEP_quench_plus", "hist_ref_sublEP_quench_plus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_ref_sublEP_quench_minus = new THnSparseD("hist_ref_sublEP_quench_minus", "hist_ref_sublEP_quench_minus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_ref_leadEP_quench_plus = new THnSparseD("hist_ref_leadEP_quench_plus", "hist_ref_leadEP_quench_plus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_ref_leadEP_quench_minus = new THnSparseD("hist_ref_leadEP_quench_minus", "hist_ref_leadEP_quench_minus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_gen_leadEP_quench_plus = new THnSparseD("hist_gen_leadEP_quench_plus", "hist_gen_leadEP_quench_plus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_gen_leadEP_quench_minus = new THnSparseD("hist_gen_leadEP_quench_minus", "hist_gen_leadEP_quench_minus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_gen_sublEP_quench_plus = new THnSparseD("hist_gen_sublEP_quench_plus", "hist_gen_sublEP_quench_plus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_gen_sublEP_quench_minus = new THnSparseD("hist_gen_sublEP_quench_minus", "hist_gen_sublEP_quench_minus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_fake_leadEP_quench_plus = new THnSparseD("hist_fake_leadEP_quench_plus", "hist_fake_leadEP_quench_plus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_fake_leadEP_quench_minus = new THnSparseD("hist_fake_leadEP_quench_minus", "hist_fake_leadEP_quench_minus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_fake_sublEP_quench_plus = new THnSparseD("hist_fake_sublEP_quench_plus", "hist_fake_sublEP_quench_plus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
THnSparseD *hist_fake_sublEP_quench_minus = new THnSparseD("hist_fake_sublEP_quench_minus", "hist_fake_sublEP_quench_minus", 9, bins_quencEPx, xmin_quencEPx, xmax_quencEPx);
...
fhUnfoldingResponse_xjpt2->GetAxis(5)->Set(bins_unfxjpt2[5],MultCentbins);
