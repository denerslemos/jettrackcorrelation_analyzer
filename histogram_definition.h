...
THnSparseD *hist_reco_alldijet_corr = new THnSparseD("hist_reco_alldijet_corr", "hist_reco_alldijet_corr", 5, bins_jet, xmin_jet, xmax_jet);
...
hist_reco_alldijet_corr->GetAxis(3)->Set(bins_jet[3],MultCentbins);
...
hist_reco_alldijet_corr->GetAxis(4)->Set(bins_jet[4],Extrabins);
